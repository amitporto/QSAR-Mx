...
def datasel(i,j,filex1,dct):
    ...
    if x2.shape[1]!=x1.shape[1]:
       messagebox.showinfo('Error','descriptors for components mismatch')
    else:
...
def process(file1,file2,file3,filer,cfile,i,j,dct):
    ...
    lcoq2,lcomae,lcorm2,lcodrm2,tsc1,tsc=lc.fit()
    #xname1=str(i)+str(j)+'_LCO_C1.csv'
    #xname2=str(i)+str(j)+'_LCO_C2.csv'
    #tsc1.to_csv(os.path.join(dct,xname1),index=False)
    #tsc.to_csv(os.path.join(dct,xname2),index=False)
    ...
    filer.write('Maximum intercorrelation between descriptors: '+str(mc)+"\n")
    ...
    filer.write('Q2LCO: '+str(lcoq2)+"\n")
    filer.write('AARD: '+str(aard)+"\n")
    filer.write('LCO_MAE: '+str(lcomae)+"\n")
    filer.write('LCO_rm2: '+str(lcorm2)+"\n")
    filer.write('LCO_drm2: '+str(lcodrm2)+"\n")
    ...
    cfile.write('LCO_MAE: '+str(lcomae)+"\n")
...
Selection = StringVar()
Criterion_sel1 = ttk.Radiobutton(tab1, text='Points-out', variable=Selection, value='Point-out')
Criterion_sel2 = ttk.Radiobutton(tab1, text='Mixtures-out', variable=Selection, value='Mixture-out')
Criterion_sel3 = ttk.Radiobutton(tab1, text='Compounds-out', variable=Selection, value='Compound-out')
...
thirdLabelTabThreer2c2.place(x=50,y=330)
thirdEntryTabThreer3c2=Entry(tab1)
thirdEntryTabThreer3c2.place(x=180,y=333)

fourthLabelTabThreer4c2=Label(tab1, text='Variance cutoff',font=("Helvetica", 12))
fourthLabelTabThreer4c2.place(x=330,y=330)
fourthEntryTabThreer5c2=Entry(tab1)
fourthEntryTabThreer5c2.place(x=445,y=333)

fifthLabelTabThreer6c2 = Label(tab1, text= 'Maximum steps',font=("Helvetica", 12))
fifthLabelTabThreer6c2.place(x=80,y=370)
fifthBoxTabThreer6c2= Spinbox(tab1, from_=0, to=100, width=5)
fifthBoxTabThreer6c2.place(x=200,y=370)

fifthLabelTabThreer8c2 = Label(tab1, text= '%MAE(LOO) reduction',font=("Helvetica", 12))
fifthLabelTabThreer8c2.place(x=260,y=370)
fifthLabelTabThreer9c2=Entry(tab1)
fifthLabelTabThreer9c2.place(x=430,y=370)

fifthLabelTabThreer7c2 = Label(tab1, text= 'Cross validation',font=("Helvetica", 12))
